...
- **Global Component Styles**: Styles that are shared between multiple components or are used inside dynamic template outlets (like `.chat__bubble`, `.chat__message`, and `.chat__bubble--thinking`) **MUST** be placed in the global component layer (e.g., [src/styles/components/_chat.scss](file:///home/ingvar/PhpstormProjects/gdg-hackathon/solution-system/apps/frontend/src/styles/components/_chat.scss)) and imported in the global [styles.scss](file:///home/ingvar/PhpstormProjects/gdg-hackathon/solution-system/apps/frontend/src/styles.scss).
...
1. **Tier 1: Primitives** ([_primitives.scss](file:///home/ingvar/PhpstormProjects/gdg-hackathon/solution-system/apps/frontend/src/styles/tokens/_primitives.scss)):
   - Defines the raw color palette scales, spacing grid, and font stacks.
   - Example: `--color-blue-500: #3b82f6;`, `--space-4: 1rem;`
2. **Tier 2: Semantics** ([_semantic.scss](file:///home/ingvar/PhpstormProjects/gdg-hackathon/solution-system/apps/frontend/src/styles/tokens/_semantic.scss)):
